...
const STORAGE_KEY = 'vescom_privacidad_aceptada'
...
export default function Login() {
  ...
  // Si ya aceptó antes (sessionStorage), no vuelve a mostrar el modal en esta sesión
  ...
  return (
    <>
      {/* Modal de privacidad — se muestra hasta que el usuario acepte */}
      {!privacidadAceptada && (
        <ModalPrivacidad onAceptar={handleAceptarPrivacidad} />
      )}
      ...
      <div className="login-page">
        ...
        <div className="login-right">
          <div className="login-card">
            ...
            {/* Link para volver a leer la política */}
            <div className="login-card-footer">
              <span className="mono">ESCOM-IPN · 2026-A023</span>
              <button
                type="button"
                className="login-privacidad-link"
                onClick={() => {
